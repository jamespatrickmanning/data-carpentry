...
def plot_data(cube, month, gridlines=True,levels=None):
    """Plot the data."""
        
    fig = plt.figure(figsize=[12,5])    
    # old levels =numpy.arange(0, 10),
...
if __name__ == '__main__':
    ...
    parser.add_argument("--gridlines", action="store_true",default=True,help="Include gridlines on the plot")
